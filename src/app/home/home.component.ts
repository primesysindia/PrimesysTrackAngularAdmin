      ...
      if(this.liveTrack.event == 'current_location'){
        ...
        if(this.currUser.accSqliteEnable == 0){
          if(!this.rdpsDataAvail) {
            this.showRdpsMsg = true;
          }
          else if(this.browserName == "Chrome" && this.rdpsDataAvail){
            this.showRdpsMsg = false;
            this.getFeatureAddressSignal().then(
              (res:any) => {
                ...
                console.log("this.sortedFeatureAdrs", this.sortedFeatureAdrs)
